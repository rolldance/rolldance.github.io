...
(function ($) {
    ...
    $.fn.dialogbox = function ($options, $callback) {
        ...
        '<div class="dialogbox-message"></div>' + '<div class="dialogbox-message1"></div>'+
        ...
        switch($settings['type']) {
            ...
            case 'error':
                ...
                $($id + ' .dialogbox-button-bar').html('').append('<div class="dialogbox-btn">阅读完毕</div>');
                break;
            // Questions
            case 'yes/no':
                $($id + ' .dialogbox-prompt').hide();
        ...
        $($id + ' .dialogbox-message1').html($settings['message1']);
